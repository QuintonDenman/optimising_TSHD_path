...
class Map(object):
    ...
    def __init__(self, ship, features, width=640, height=400, fps=30):
        ...
        self.vel_limit = 3
        self.pos = np.array([[self.shp.pos[0]], [self.ship.pos[1]], [self.shep.heading]], dtype=np.float)
...
class Ship(object):
    ...
    def __init__(self, pos, size=(15, 50), color=(0, 0, 255)):
